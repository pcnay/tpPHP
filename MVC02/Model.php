<?php
  ...
  // Se reutiliza este codigo para todo los módulos de la aplicación, ya que 
  // no se refiere a uno en especifico.
  abstract class Model
  {
    ...
    {
      $this->db_open();
      // $this->query = Se utiliza para asignar la consulta, independiente de que módulo
      // de la aplicación lo este usando
      ...
      // "array_pop" se agrega ya que borra el último elemento, ya que por defecto agrega un null al final.
